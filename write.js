...
$(function() { 
    $("#fat-btn").click(function() { 
        if($(".number:last").val() == "") { 
            ...
            htm += "<div data-v-64862834 class='qu-item'><h3 data-v-64862834><span data-v-64862834 class='qu-num'>Q";
            htm+=FieldCount;
            htm+="</span><input type='text' id='dan' placeholder='单选题'></h3><ul data-v-64862834 class='options-list'><li data-v-64862834 class><input type='text' class='one' placeholder='选项1'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type='text' class='two' placeholder='选项2'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type='text' class='three' placeholder='选项3'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type='text' class='four' placeholder='选项4'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li></ul><label data-v-64862834 id='require-check'><a href='#' class='check'></a><input type='checkbox' id='taskDepartment'>是否必填</label><ul data-v-64862834 class='operat-list'><input class='UpBtn' type='button' value='上移'> <input class='Down' type='button' value='下移'> <input class='Copy' type='button' value='复用'><a href='#' class='removeclass'><input type='button' value='删除'></a></ul><br></span>"; 
            $('#opts').append(htm); 
            FieldCount++;
            }
        } 
...
$(function() { $("#fat-btnduo").click(function() { 
    if($(".number:last").val() == "") {
         alert(1) 
    } 
    else { 
        ...
        htm += "<div data-v-64862834 class='qu-item'><h3 data-v-64862834><span data-v-64862834 class='qu-num'>Q";
        htm+=FieldCount;
        htm+="</span><input type='text' id='dan' placeholder='多选题'></h3><ul data-v-64862834 class='options-list'><li data-v-64862834 class><input type='text' class='one' placeholder='选项1'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type='text' class='two' placeholder='选项2'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type='text' class='three' placeholder='选项3'><ul data-v-64862834 class='opt-ctrl'>li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type='text' class='four' placeholder='选项4'><ul data-v-64862834 class='opt-ctrl'><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li></ul><label data-v-64862834 id='require-check'><a href='#' class='check'></a><input type='checkbox' id='taskDepartment'>是否必填</label><ul data-v-64862834 class='operat-list'><input class='UpBtn' type='button' value='上移'> <input class='Down' type='button' value='下移'> <input class='Copy' type='button' value='复用'><a href='#' class='removeclass'><input type='button' value='删除'></a></ul><br></div>"; 
        $('#opts').append(htm); 
        FieldCount++;
        }
    } 
...
$(function() { 
    $("#fat-btnwen").click(function() { 
        if($(".number:last").val() == "") { 
            ...
            htm+=FieldCount;
            htm+="</span>";
            htm+='<span data-v-64862834 class="qu-topic">文本题</span><input data-v-64862834 type="text"></h3><textarea data-v-64862834 rows="10" cols="109"></textarea><label data-v-64862834 id="require-check"><a href="#" class="check"></a><input type="checkbox" id="taskDepartment">是否必填</label><ul data-v-64862834 class="operat-list"><input class="UpBtn" type="button" value="上移"><input class="Down" type="button" value="下移"> <input class="Copy" type="button" value="复用"><a href="#" class="removeclass"><input type="button" value="删除"></a></ul><br></div>'; 
            $('#opts').append(htm); 
            FieldCount++;
            }
        } 
...
$('#taskDepartment').change(function(){
    alert("该题成为必选题！");
    $('#taskDepartment').validatebox({
        required:true
    }) 
...
function save(){
    var qr = confirm("确认保存答案吗？")
    if(qr == true){
        alert("成功保存！")
        window.location.href="file:///C:/Users/86178/Desktop/question/html/list.html"
    }
}
function send(){
    var qr = confirm("确认发布问卷吗？")
    if(qr == true){
        alert("成功发布！")
        window.location.href="file:///C:/Users/86178/Desktop/question/html/list.html"
    }
...
{  
        ...
        {  
            ...
            //add input box  
            $(InputsWrapper).append('<section data-v-64862834 class="qu-item"><h3 data-v-64862834><span data-v-64862834 class="qu-num">Q4</span><input type="text" id="dan" placeholder="单选题"></h3><ul data-v-64862834 class="options-list"><li data-v-64862834 class><input type="text" class="one" placeholder="选项1"><ul data-v-64862834 class="opt-ctrl"><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type="text" class="two" placeholder="选项2"><ul data-v-64862834 class="opt-ctrl"><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type="text" class="three" placeholder="选项3"><ul data-v-64862834 class="opt-ctrl">li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type="text" class="four" placeholder="选项4"><ul data-v-64862834 class="opt-ctrl"><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li></ul><ul data-v-64862834 class="operat-list"><li data-v-64862834>下移</li><li data-v-64862834>复用</li><li data-v-64862834>删除</li></ul><div data-v-64862834></div></section>');  
            x++; //text box increment  
        }  
return false;  
});  
$(AddButton).click(function (f)  //on add input button click  
{  
        ...
        {  
            FieldCount++; //text box added increment  
            //add input box  
            $(InputsWrapperduo).append('<section data-v-64862834 class="qu-item"><h3 data-v-64862834><span data-v-64862834 class="qu-num">Q5</span><input type="text" id="dan" placeholder="多选题"></h3><ul data-v-64862834 class="options-list"><li data-v-64862834 class><input type="text" class="one" placeholder="选项1"><ul data-v-64862834 class="opt-ctrl"><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type="text" class="two" placeholder="选项2"><ul data-v-64862834 class="opt-ctrl"><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type="text" class="three" placeholder="选项3"><ul data-v-64862834 class="opt-ctrl">li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li><li data-v-64862834 class><input type="text" class="four" placeholder="选项4"><ul data-v-64862834 class="opt-ctrl"><li data-v-64862834>上移</li><li data-v-64862834>下移</li><li data-v-64862834>删除</li></ul></li></ul><ul data-v-64862834 class="operat-list"><li data-v-64862834>下移</li><li data-v-64862834>复用</li><li data-v-64862834>删除</li></ul><div data-v-64862834></div></section>');  
            x++; //text box increment  
        }  
return false;  
}); 
$(AddButton).click(function (g)  //on add input button click  
{  
        ...
        {  
            FieldCount++; //text box added increment  
            //add input box  
            $(InputsWrapperwen).append('<section data-v-64862834 class="qu-item"><h3 data-v-64862834><span data-v-64862834 class="qu-num">Q6</span><span data-v-64862834 class="qu-topic">文本题</span><input data-v-64862834 type="text"></h3><textarea data-v-64862834 rows="10" cols="100"></textarea><label data-v-64862834 id="require-check"><a href="#" class="check"></a><input type="checkbox" id="taskDepartment">是否必填</label><ul data-v-64862834 class="operat-list"><li data-v-64862834>上移</li><li data-v-64862834>复用</li><li data-v-64862834>删除</li></ul><div data-v-64862834></div></section>');  
            x++; //text box increment  
        }  
return false;  
}); 
